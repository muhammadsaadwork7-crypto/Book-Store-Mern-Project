  ...
  return (
    <>
        ...
        <div className='px-4 md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-8'>
            ...
            <div className=' rounded  p-12 flex flex-col lg:flex-row justify-around bg-zinc-800'>
            ...
            {isLoggedIn === true && role === "user" && (
              ...
              <button className='text-white rounded lg:rounded-full mt-8 md:mt-0 text-3xl p-3  lg:mt-8 bg-blue-500 flex items-center justify-center'
              onClick={handleCart}>
