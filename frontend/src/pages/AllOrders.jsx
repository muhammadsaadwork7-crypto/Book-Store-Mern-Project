    ...
    <>
      ...
      {AllOrders && AllOrders.length>0 && 
        ...
        AllOrders.map((items,i) => (
          <div className='bg-zinc-800 w-full rounded py-2 px-4 flex gap-2 hover:bg-zinc-900 hover:cursor-pointer transition-all duration-75' key={items._id}>
            <div className='w-[3%]'>
            ...
            <div className='w-0 md:w-[45%] hidden md:block'>
              <h1 className=''>{items.book?.desc?.slice(0,50) || "No description available"}</h1>
            </div>
